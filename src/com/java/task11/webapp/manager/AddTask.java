...
public class AddTask extends HttpServlet {
    private static Logger log = Logger.getLogger(AddTask.class);
...
//            test
//            for (int i = 0; i < usersAssignedToProject.size(); i++) {
//                System.out.println(usersAssignedToProject.get(i).getFirstName());
//            }
